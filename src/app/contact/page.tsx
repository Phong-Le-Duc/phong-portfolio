    ...
    return (
        <main className="mx-8 py-10">
            <section className="max-w-4xl">
                <p className="text-sm uppercase tracking-[0.3em] text-blue-500">Contact</p>
                <h1 className="mt-3 text-4xl font-semibold text-white md:text-5xl">Let&apos;s build something great</h1>
                <p className="mt-4 max-w-3xl text-sm leading-6 text-gray-300 md:text-base">
                    I am open to new opportunities and freelance projects. Feel free to reach out if you want to
            ...
            <section className="mt-10 grid gap-8 lg:grid-cols-[0.9fr_1.1fr]">
                <div className="rounded-2xl border border-gray-700 bg-white/5 p-6">
                    <div className="relative mx-auto aspect-square w-44 overflow-hidden rounded-2xl border border-gray-700">
                        <Image
                    ...
                    <div className="mt-6 space-y-3 text-sm">
                        <a
                            ...
                            className="block rounded-lg border border-gray-700 bg-black/30 px-4 py-3 text-gray-200 transition hover:border-blue-500 hover:text-white"
                        >
                            Phone: 42 58 25 61
                        </a>
                        <a
                ...
                <div className="rounded-2xl border border-gray-700 bg-white/5 p-6">
                    ...
                    <div className="mt-6 grid gap-4 sm:grid-cols-2">
                        <a
                            href="mailto:phongleduc@gmail.com"
                            className="rounded-xl border border-blue-500 bg-blue-500/10 px-4 py-3 text-center text-sm font-medium text-blue-200 transition hover:bg-blue-500/20"
                        >
                            Send email
                        </a>
                        <a
                            href="tel:+4542582561"
                            className="rounded-xl border border-gray-700 bg-black/30 px-4 py-3 text-center text-sm font-medium text-gray-200 transition hover:border-blue-500 hover:text-white"
                        >
                            Call now
                        </a>
                    </div>
                    ...
                    <div className="mt-8 rounded-xl border border-dashed border-gray-600 bg-black/20 p-4">
                        ...
                        <p className="mt-2 text-sm text-gray-300">Open for frontend roles, selected freelance projects, and company internship opportunities.</p>
                    </div>
                </div>
            </section>
        </main>
